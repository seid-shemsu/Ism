...
public class DeclinedAdapter extends RecyclerView.Adapter<DeclinedAdapter.Holder> {
    Context context;
    List<Request> requests;
    String type;

    public DeclinedAdapter(Context context, List<Request> requests, String type) {
